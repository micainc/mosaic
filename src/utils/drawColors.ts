...
// 128 maximally distinct, high-visibility colors.
// Generated using golden angle (137.508°) hue spacing in HSL space
// with varied saturation (55-95%) and lightness (35-65%) for maximum
// perceptual distance. Excludes black, white, and gray (reserved).

// export const drawColors: string[] = [
//   '#C91D1D', '#EE2B2B', '#A82424', '#F53D3D',
//   '#1DC94F', '#2BEE64', '#24A84A', '#3DF573',
//   '#811DC9', '#9D2BEE', '#7124A8', '#A83DF5',
//   '#C9B31D', '#EED52B', '#A89824', '#F5DE3D',
//   '#1DACC9', '#2BCDEE', '#2492A8', '#3DD6F5',
//   '#C91D7A', '#EE2B94', '#A8246B', '#F53DA1',
//   '#48C91D', '#5BEE2B', '#45A824', '#6BF53D',
//   '#241DC9', '#332BEE', '#2924A8', '#453DF5',
//   '#C9561D', '#EE6C2B', '#A85024', '#F57B3D',
//   '#1DC988', '#2BEEA5', '#24A877', '#3DF5B0',
//   '#BB1DC9', '#DE2BEE', '#9D24A8', '#E63DF5',
//   '#A5C91D', '#C5EE2B', '#8CA824', '#CEF53D',
//   '#1D72C9', '#2B8CEE', '#2466A8', '#3D99F5',
//   '#C91D40', '#EE2B53', '#A8243F', '#F53D63',
//   '#1DC92B', '#2BEE3B', '#24A82F', '#3DF54D',
//   '#5E1DC9', '#742BEE', '#5624A8', '#823DF5',
//   '#C9901D', '#EEAD2B', '#A87C24', '#F5B83D',
//   '#1DC9C2', '#2BEEE6', '#24A8A3', '#3DF5EE',
//   '#C91D9D', '#EE2BBD', '#A82487', '#F53DC6',
//   '#6BC91D', '#84EE2B', '#60A824', '#91F53D',
//   '#1D39C9', '#2B4BEE', '#2439A8', '#3D5BF5',
//   '#C9331D', '#EE442B', '#A83524', '#F5553D',
//   '#1DC965', '#2BEE7D', '#24A85B', '#3DF58A',
//   '#971DC9', '#B52BEE', '#8224A8', '#C03DF5',
//   '#C8C91D', '#EDEE2B', '#A8A824', '#F4F53D',
//   '#1D96C9', '#2BB4EE', '#2481A8', '#3DBFF5',
//   '#C91D64', '#EE2B7B', '#A8245A', '#F53D89',
//   '#32C91D', '#42EE2B', '#34A824', '#53F53D',
//   '#3A1DC9', '#4C2BEE', '#3A24A8', '#5C3DF5',
//   '#C96C1D', '#EE852B', '#A86124', '#F5923D',
//   '#1DC99E', '#2BEEBE', '#24A888', '#3DF5C8',
//   '#C91DC1', '#EE2BE5', '#A824A2', '#F53DEC',
// ];
...
export function mapLabelsToColors(labelNames: string[], colors: string[]): Record<string, string> {
  ...
  const sortedLabelNames = [...labelNames].sort();
  ...
  colourLabelMap['omit'] = '#000000';
  colourLabelMap['#000000'] = 'omit';
