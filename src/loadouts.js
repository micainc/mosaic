...
function initLoadouts(loadouts) {
  ...
  add.addEventListener("click", function(e) {
    ...
    $("#labels > .toolbar-list-items").empty();
    activeCursor = false;

    // when 'add' button is clicked, move selected item into item-list. 
    try {
      var a = $("#loadouts")[0].firstChild;
      a.classList.toggle("selected")
      $("#loadouts > .toolbar-list-items")[0].prepend(a)
    } catch {
...
function initLabels(labels) {
  ...
  add.addEventListener("click", function(e) {
    ...
    try {
      ...
      a.classList.toggle("selected")
      $("#labels > .toolbar-list-items")[0].prepend(a)
    } catch {
      console.log("No selected item...")
    }
...
function onSelectItem(e) {
  ...
  if(this.classList.contains("selected") && !this.classList.contains("search-box") ) {
    ...
    var items = list.getElementsByClassName("toolbar-list-items")[0]
...
function onBlur(e) {
  ...
  if(e.relatedTarget === null) {
    ...
    return;
  }else if(!e.relatedTarget.parentNode.classList.contains('toolbar-list-items') || !e.relatedTarget.parentNode.parentNode.classList.contains('toolbar-list')) {
    this.classList.toggle("hidden");
    items.classList.toggle("hidden");
  } 
}
